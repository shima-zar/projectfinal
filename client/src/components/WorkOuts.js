...
function WorkOuts() {
  return (
    <div className="container">
      <h2 className="text-center">CHOOSE YOUR WORKOUT</h2>
      <div className="row">
        <div className="col-sm-4">
          <div className="item">
            <img
              src="https://images.pexels.com/photos/4162449/pexels-photo-4162449.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500"
        ...
        <div className="col-sm-4">
          <div className="item">
            <img
              src="https://images.pexels.com/photos/4325462/pexels-photo-4325462.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500"
              className="img-thumbnail"
            />
          </div>
          {/* PILATES */}
