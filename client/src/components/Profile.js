                ...
                <div className="row">
                  ...
                  <div className="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    ...
                    <p>
                      ...
                      where to start? Tell us about your project and we’ll send
                      you a list of Personal Trainers to review. There’s no
                      pressure to hire, so you can compare profiles, read
              ...
              <a href="#">
                <div className="row">
                  <div className="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                    <div className="image">
                      <Link
                        to={{ pathname: "https://www.eatyourselfskinny.com/" }}
                        target="_blank"
                      >
                        <img
                  ...
                  <div className="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    ...
                    <p>
                      ...
                      calories for how active you are so you balance the energy
                      you consume with the energy you use. If you eat or drink
                      more than your body needs, you'll put on weight because
                      the energy you do not use is stored as fat. If you eat and
                      drink too little, you'll lose weight. You should also eat
                      a wide range of foods to make sure you're getting a
                      balanced diet and your body is receiving all the nutrients
                      it needs.
                    </p>
                  </div>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    ...
                    <p>
                      ...
                      just trying to get in shape, the gym is the perfect place
                      to do it. Even though the gym is an excellent destination
                      for sport and fitness activities, is it the only place to
                      go for exercise? Certainly not. Changing your environment,
                      and tailoring your physical activities to the destination
                      of your training keeps things interesting and can train
                      your body and muscles in ways that gym equipment won’t.
                    </p>
                  </div>
                </div>
              </a>
